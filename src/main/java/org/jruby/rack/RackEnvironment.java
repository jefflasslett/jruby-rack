...
public interface RackEnvironment {
    ...
    /**
     * {@link RackEnvironment} extension to obtain a rack.hijack.
     *
     * @author jefflasslett
     */
    interface ToHijack {
        ...
        /**
         * Convert this environment into a "rack.hijack" object.
         * @return rack.hijack
         */
        ...
        /**
         * Set the rack.hijack.
         * @param hijack the rack.hijack instance
         */
        void setHijack(RackHijack hijack) ;
